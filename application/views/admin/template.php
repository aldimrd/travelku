...
<head>
  ...
  <link rel="icon" type="image/x-icon" src="<?php echo base_url() . "assets/" ?>favicon/favicon.ico"> 
</head>
...
<body>
  <header>
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        ...
        <ul class="side-nav fixed white lighten-4" id="mobile-demo">
          <div class="side-logo hide-sm">
            <img src="<?= base_url() . "assets/" ?>images/new_logo/logo.png">
          </div>
          <li>
            <div class="user-view">
          ...
          <li><a href="<?= site_url('admin/dashboard') ?>"><i class="material-icons">dashboard</i>Dashboard</a></li>
          <li class="no-padding">
          ...
          <li><a href="<?= site_url('admin/place') ?>"><i class="material-icons">location_on</i>Bandara</a></li>
  ...
  <footer class="page-footer">
    <div class="footer-copyright blue">
      <div class="container">
        <span>Copyright &copy; <?= date('Y'); ?> <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">Travelku</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="<?=base_url()?>">Kelompok 4</a></span>
      </div>
    </div>
  </footer>
