    ...
    <nav class="nav-material grey lighten-5">
      <div class="nav-wrapper">
        <a style="padding-left: 20px;padding-top: 3px" href="<?= site_url() ?>" class="brand-logo">
          <img class="img-brand" src="<?= base_url() . "assets/" ?>images/new_logo/logo.png">
        </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">
            <img src="<?= base_url('assets/images/new_logo/logo-text-white.png') ?>">
          </h5>
          <p class="grey-text text-lighten-4">
            Booking Online Tiket Pesawat</p>
        </div>
