...
(2, 'Muhamad Rivalda', 'valda@gmail.com', '', '', 3, '2021-05-26');
...
(2, 300000, 1, 'Muhamad Rivalda', 'valda@gmail.com', '08979792421', 'Terbayar', '2021-05-26', '20:52:08', 2, 0),
(3, 250000, 1, 'Muhamad Rivalda', 'rivaldamuhamad96@gmail.com', '+628979792421', 'Terbayar', '2021-06-08', '10:15:19', 2, 0),
(4, 200000, 1, 'Muhamad Rivalda', 'rivaldamuhamad96@gmail.com', '+628979792421', 'Terbayar', '2021-06-11', '13:58:03', 2, 0),
(5, 150000, 1, 'Muhamad Rivalda', 'rivaldamuhamad96@gmail.com', '+628979792421', 'Tertunda', '2021-06-28', '09:35:11', 2, 0);
...
(2, 2, 'Muhamad Rivalda', 'Tn', 'TGDUD0CPCO5'),
(3, 3, 'Muhamad Rivalda', 'Tn', 'TGLCOWZEJGV'),
(4, 4, 'Muhamad Rivalda', 'Tn', 'TGDZXGPPFVL'),
(5, 5, 'Muhamad Rivalda', 'Tn', 'TGC5T3VJJLB');
...
(2, 1, 'Soekarno Hatta', 1, 'CGK'),
(5, 1, 'Husein Sastranegara', 2, 'BDO'),
(6, 1, 'Djuanda', 4, 'SUB'),
(7, 1, 'Ngurah Rai', 5, 'DPS');
...
(2, '2021-05-27', '2021-05-27', '21:00:00', '23:00:00', 2, 5, 300000, 6, 1),
(3, '2021-06-08', '2021-06-08', '11:00:00', '12:00:00', 1, 2, 250000, 1, 1),
(4, '2021-06-11', '2021-06-11', '15:00:00', '16:00:00', 1, 2, 200000, 7, 1),
(5, '2021-06-28', '2021-06-28', '10:00:00', '11:00:00', 1, 2, 150000, 1, 1);
...
(6, 'GI-119', 'AirbusA330', 1, 1, 100, 8),
(7, 'GI-110', 'Garuda Indonesia', 3, 1, 100, 8);
...
(16, 'Wings Air', 1, 'wingsair.png'),
(17, 'Trans Nusa', 1, 'transnusa.png'),
(18, 'Nam Air', 1, 'namair.png'),
(19, 'Xpress Air', 1, 'xpress.png');
...
(3, 'valda@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 2);
...
--
ALTER TABLE `costumer`
  MODIFY `id_costumer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `promo_code`
  MODIFY `id_promo_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `transportation`
  MODIFY `id_transportation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `transportation_class`
--
ALTER TABLE `transportation_class`
  MODIFY `id_transportation_class` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
